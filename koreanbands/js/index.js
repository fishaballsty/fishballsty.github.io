...
(function($, window, undefined){
  ...
  Hangman = {
    ...
    _wordData: function(word, numbers){
    ...
    _letters: function(word, numbers){
      var letters = [];
  ...
  var wordList = ["twice", "beast", "fourminute", "apink", "shinee", "exo", "girlsgeneration", "sistar", "boyfriend", "monstarx", "fx", "redvelvet", "vixx", "btob", "superjunior", "bigbang", "twoneone", "winner", "ikon", "twopm", "twoam", "wondergirls", "gotseven", "missa", "JJProject", "epikhigh", "gfriend", "infinite", "lovelyz", "exid", "bestie", "teentop", "bap", "bts", "boysrepublic", "kara", "tara", "seventeen", "clc", "ohmygirl", "mamamoo", "ninemuses", "100percent", "rainbow", "hellovenus", "dalshabet", "playback", "twox", "sunnyhill", "wassup", "purfles", "sunnydays", "jewelry", "sonamoo", "crayonpop", "minx", "poten", "akor", "spica", "tahiti", "ladiescode", "afterschool", "orangecaramal", "secret", "aoa", "girlsday", "toppdogg", "ukiss", "jjcc", "history", "ajax", "crossgene", "speed", "big", "cclown"];
